...
2) Use the solution made in the function `enclosing_function_1` as a basis.
Modify ONE LINE (do not remove or add a new one) 
in inner_function to make it print variable 'a' from global scope.

3) Use the solution made in the function `enclosing_function_1` as a basis. 
Modify ONE LINE (do not remove or add anew one) 
in inner_function to make it print variable 'a' form enclosing function.
